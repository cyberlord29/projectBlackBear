...
<body>
    <div id="sine-chart" style="width: 500px; height: 250px"></div>
    <h1>Legacy Components</h1>
    <div id="sine-svg" style="width: 500px; height: 250px"></div>
    <div id="sine-canvas" style="width: 500px; height: 250px"></div>
